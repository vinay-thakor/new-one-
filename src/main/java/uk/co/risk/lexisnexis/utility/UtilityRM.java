package uk.co.risk.lexisnexis.utility;
...
//and then help sort the lists by ascending/descending order for String or alphabetical values
    ...
    public static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "/src/main/java/uk/co/risk/lexisnexis/screenshots/";
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "/src/main/java/uk/co/risk/lexisnexis/screenshots/" + screenshotName + dateName + ".png";
